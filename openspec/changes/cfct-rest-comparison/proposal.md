...
- **External dependency**: requires the cfct automation API (`GET /api/automation/comparison.json`, which refreshes then returns the comparison) to be available and return the agreed JSON contract.
